...
$(function(){
	...
	function renderBreadcrumbs(path) {
		var base = "",
			$html = $('<div/>').append( $('<a href="../admin/index.php">Trang chính</a></div>') );
...
<div id="top">
	<form action="?" method="post" id="mkdir" />
		<label for=dirname>Tạo thư mục mới</label><input id=dirname type=text name=name value="" />
...
<footer><center>UIT DMS <a href="../admin/index.php"> Admin Panel</a></center><footer>
</body></html>