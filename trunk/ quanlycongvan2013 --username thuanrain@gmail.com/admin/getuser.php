...
while($row = mysql_fetch_array($result))
  {
  echo "<tr>";  echo "<td>" . $row['maquyen'] . "</td>";  echo "<td>" . $row['tenquyen'] . "</td><td><input type='checkbox' name='cbox[]'"; if($row['maquyen']==2) echo"checked=checked"; else echo""; echo "value=" . $row['maquyen'] . "></input> </td>";
  echo "</tr>";
  }
echo "</table>";
?>