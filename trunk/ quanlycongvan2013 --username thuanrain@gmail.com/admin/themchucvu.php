	...
	<div class="main-wrap">
		...
		<div class="page clear">
			...
			<div class="content-box">
				...
				<form id='themus' action='javascript:themchucvu()' method='post'><fieldset class="them" >
	
					<p><label for='tencv'>Tên chức vụ: </label><span><input id='tencv' type='text' tabindex='2'></span></p>
					
					<p><span><input type="submit" class="round button blue" value="Thêm mới"></span></p>
				</fieldset></form>
				<div id='kqthemchucvu'></div>      	
