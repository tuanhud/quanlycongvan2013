...
//		$mapb = $_SESSION['phongban'];
  ...
  $mapb = $_SESSION['phongban'];
   ...
   include ('dbcon.php');
	 if($key == 1)
	 {
		$sqlcv = "select distinct congvan.isfile,congvan.madk,congvan.soKH, congvan.ngayVB,congvan.sotrang, congvan.domat, congvan.trichyeu,trangthaixuly.trangthai, congvan.tacgia,congvan.loaicv, congvan.nguoixuly from congvan,trangthaixuly where congvan.madk = trangthaixuly.madk and congvan.nguoixuly = '".$manv."'";
		?>
	...
	<?php	
	 ...
	 if($key == 2)
	 {
		$sqlcv = "select distinct congvan.isfile,congvan.madk,congvan.soKH, trangthaixuly.trangthai, congvan.ngayVB,congvan.sotrang, congvan.domat, congvan.trichyeu, congvan.tacgia,congvan.loaicv, congvan.nguoixuly from congvan,trangthaixuly where congvan.madk = trangthaixuly.madk and congvan.nguoixuly = '".$manv."' and trangthaixuly.trangthai = '2'";
	?>
	<div class="content-module-heading cf">
